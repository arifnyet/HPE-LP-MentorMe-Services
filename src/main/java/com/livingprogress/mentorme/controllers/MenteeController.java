...
public class MenteeController extends BaseEmailController {
    ...
    public List<Mentor> getMatchingMentors(@PathVariable long id,
        ...
        for (Mentor mentor : mentors) {
            ...
            mentor.distance = Helper.calculateDistance(mentor.getLatitude().doubleValue(),mentor.getLongitude().doubleValue(),mentee.getLatitude().doubleValue(),mentor.getLongitude().doubleValue());
        }
