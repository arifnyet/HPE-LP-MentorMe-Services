...
public class MentorController {
    ...
    public List<Mentee> getMatchingMentees(@PathVariable long id,
        ...
        for (Mentee mentee : mentees) {
            ...
            mentee.distance = Helper.calculateDistance(mentor.getLatitude().doubleValue(),mentor.getLongitude().doubleValue(),mentee.getLatitude().doubleValue(),mentor.getLongitude().doubleValue());
        }
